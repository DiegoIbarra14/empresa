...
<head>
    ...
    <link rel="stylesheet" href="./assets/assets/plugin/components/Font Awesome/css/font-awesome.min.css">
...
<!-- Then, in the player -->
    ...
    <title><?php echo "Tienda online"."-".$data["title"]?></title>
        ...
        <nav id="nav"  class="navbar navbar-expand-lg navbar-light shadow">
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <a id="content-logo" class="navbar-brand text-success logo h1 align-self-center" href="index.html">
                    <img src="./assets/assets/images/LOGUITO.PNG" alt="">
                </a>
                ...
                <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                    <div class="flex-fill">
                        <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo BASE_URL."principal/"."nosotros"?>">Nosotros</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="http://localhost/trabajo/productos/">Productos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo BASE_URL."principal/"."contacto"?>">Contacto</a>
                            </li>
                        </ul>
                    </div>
                    <div id="nav-left" class="navbar align-self-center d-flex">
                        ...
                        <a id="carrito" class="nav-icon position-relative text-decoration-none" href="#">
                            ...
                            <span class="position-absolute  top-0 left-100 translate-middle badge rounded-pill bg-info text-dark" id="cantidadCarrito"></span>
                        </a>
